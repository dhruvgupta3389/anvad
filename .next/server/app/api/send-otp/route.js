(()=>{var e={};e.id=984,e.ids=[984],e.modules={399:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8893:e=>{"use strict";e.exports=require("buffer")},1282:e=>{"use strict";e.exports=require("child_process")},4770:e=>{"use strict";e.exports=require("crypto")},665:e=>{"use strict";e.exports=require("dns")},7702:e=>{"use strict";e.exports=require("events")},2048:e=>{"use strict";e.exports=require("fs")},2615:e=>{"use strict";e.exports=require("http")},5240:e=>{"use strict";e.exports=require("https")},8216:e=>{"use strict";e.exports=require("net")},9801:e=>{"use strict";e.exports=require("os")},5315:e=>{"use strict";e.exports=require("path")},8621:e=>{"use strict";e.exports=require("punycode")},6162:e=>{"use strict";e.exports=require("stream")},2452:e=>{"use strict";e.exports=require("tls")},7360:e=>{"use strict";e.exports=require("url")},1764:e=>{"use strict";e.exports=require("util")},1568:e=>{"use strict";e.exports=require("zlib")},8359:()=>{},3739:()=>{},3791:(e,t,r)=>{"use strict";r.r(t),r.d(t,{originalPathname:()=>h,patchFetch:()=>m,requestAsyncStorage:()=>u,routeModule:()=>c,serverHooks:()=>x,staticGenerationAsyncStorage:()=>g});var o={};r.r(o),r.d(o,{POST:()=>p});var i=r(9303),s=r(8716),a=r(670),n=r(7070),l=r(6685),d=r(5228);async function p(e){try{let{email:t}=await e.json();if(!t||!t.includes("@"))return n.NextResponse.json({error:"Valid email is required"},{status:400});let r=Math.floor(1e5+9e5*Math.random()).toString();await d.O.from("otps").delete().eq("email",t);let{error:o}=await d.O.from("otps").insert({email:t,code:r});if(o)return console.error("Database error:",o),n.NextResponse.json({error:"Failed to store OTP"},{status:500});let i=await (0,l.a2)(t,r);if(!i.success)return console.error("Email error:",i.error),n.NextResponse.json({error:"Failed to send OTP email"},{status:500});return n.NextResponse.json({success:!0,message:"OTP sent successfully"},{status:200})}catch(e){return console.error("API error:",e),n.NextResponse.json({error:"Internal server error"},{status:500})}}let c=new i.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/send-otp/route",pathname:"/api/send-otp",filename:"route",bundlePath:"app/api/send-otp/route"},resolvedPagePath:"E:\\anvad\\app\\api\\send-otp\\route.ts",nextConfigOutput:"",userland:o}),{requestAsyncStorage:u,staticGenerationAsyncStorage:g,serverHooks:x}=c,h="/api/send-otp/route";function m(){return(0,a.patchFetch)({serverHooks:x,staticGenerationAsyncStorage:g})}},6685:(e,t,r)=>{"use strict";r.d(t,{Ky:()=>n,a2:()=>s,bn:()=>a});var o=r(5245);let i=()=>o.createTransport({service:"gmail",auth:{user:process.env.GMAIL_EMAIL,pass:process.env.GMAIL_APP_PASSWORD}}),s=async(e,t)=>{let r=i(),o={from:process.env.GMAIL_EMAIL,to:e,subject:"ANVEDA - Email Verification OTP",html:`
    ...
    `};try{return await r.sendMail(o),{success:!0}}catch(e){return console.error("Error sending OTP email:",e),{success:!1,error:e}}},a=async e=>{let t=i(),{email:r,name:o,orderId:s,items:a,totalPrice:n,address:l,phone:d}=e,p=a.map(e=>`
  ...
  `).join(""),c={from:process.env.GMAIL_EMAIL,to:r,subject:`Order Confirmation - #${s} - ANVEDA`,html:`
        ...
        <div style="background-color: white; padding: 30px; border-radius: 10px;">
          ...
          <div style="text-align: right; margin-bottom: 30px;">
            <div style="background-color: #7d3600; color: white; padding: 15px; border-radius: 5px; display: inline-block;">
              <h3 style="margin: 0;">Total Amount: ₹${n}</h3>
            </div>
          </div>
    ...
    `};try{return await t.sendMail(c),{success:!0}}catch(e){return console.error("Error sending order confirmation email:",e),{success:!1,error:e}}},n=async e=>{let t=i(),r={from:process.env.GMAIL_EMAIL,to:e,subject:"Welcome to ANVEDA Newsletter!",html:`
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f5ef;">
        <div style="background-color: white; padding: 30px; border-radius: 10px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #7d3600; margin-bottom: 10px;">
    ...
    `};try{return await t.sendMail(r),{success:!0}}catch(e){return console.error("Error sending newsletter welcome email:",e),{success:!1,error:e}}}},5228:(e,t,r)=>{"use strict";r.d(t,{O:()=>o});let o=(0,r(2438).eI)("https://scxpgzgxqgjnrvfybcyc.supabase.co","eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNjeHBnemd4cWdqbnJ2ZnliY3ljIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTE3NDk0NjgsImV4cCI6MjA2NzMyNTQ2OH0.l84EQBLql2WKQoRTD-0CPsLtOF5bVEdmS6IYmrKzwmg")}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),o=t.X(0,[948,770,438],()=>r(3791));module.exports=o})();